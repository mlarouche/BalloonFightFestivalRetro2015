...
__c2d2:     lda $055d,x        ; $c2d2: bd 5d 05  
            ...
            lda $05cd          ; $c2da: ad cd 05  
            beq __c2ef         ; $c2dd: f0 10     
            dec $05cd          ; $c2df: ce cd 05  
            inc $05ce          ; $c2e2: ee ce 05  
            txa                ; $c2e5: 8a        
            pha                ; $c2e6: 48        
            lda $0559          ; $c2e7: ad 59 05  
...
__c527:     jsr __d0e2         ; $c527: 20 e2 d0  
            asl $0559          ; $c52a: 0e 59 05  
            lda $0559          ; $c52d: ad 59 05  
            asl                ; $c530: 0a        
            asl                ; $c531: 0a        
            adc $0559          ; $c532: 6d 59 05  
            sta $0559          ; $c535: 8d 59 05  
            rts                ; $c538: 60        

;-------------------------------------------------------------------------------
__c539:     lda #$00           ; $c539: a9 00     
            sta $12            ; $c53b: 85 12     
__c53d:     lda $12            ; $c53d: a5 12     
            asl                ; $c53f: 0a        
            asl                ; $c540: 0a        
            adc $12            ; $c541: 65 12     
            sta $1d            ; $c543: 85 1d     
...
__c559:     inc $12            ; $c559: e6 12     
            lda $12            ; $c55b: a5 12     
            cmp #$32           ; $c55d: c9 32     
            bne __c53d         ; $c55f: d0 dc     
            dec $12            ; $c561: c6 12     
__c563:     inc $12            ; $c563: e6 12     
            lda $12            ; $c565: a5 12     
            pha                ; $c567: 48        
            sta $43            ; $c568: 85 43     
            ldy #$0a           ; $c56a: a0 0a     
...
__c602:     lda $99            ; $c602: a5 99     
            sec                ; $c604: 38        
            sbc #$04           ; $c605: e9 04     
__c607:     sta $91,x          ; $c607: 95 91     
            lda $a2            ; $c609: a5 a2     
            sec                ; $c60b: 38        
            sbc #$0a           ; $c60c: e9 0a     
            sta $9a,x          ; $c60e: 95 9a     
...
__c671:     inc $048d          ; $c671: ee 8d 04  
            ...
            ldy $0451,x        ; $c68b: bc 51 04  
            lda __c6b8,y       ; $c68e: b9 b8 c6  
            sta $0451,x        ; $c691: 9d 51 04  
            lda #$00           ; $c694: a9 00     
            sta $7f,x          ; $c696: 95 7f     
            sta $88,x          ; $c698: 95 88     
            lda $f2            ; $c69a: a5 f2     
...
__ced0:     lda $0088,y        ; $ced0: b9 88 00  
            ...
            lda $05cd,y        ; $cf01: b9 cd 05  
            clc                ; $cf04: 18        
            adc #$01           ; $cf05: 69 01     
            sta $05cd,y        ; $cf07: 99 cd 05  
            lda #$02           ; $cf0a: a9 02     
            sta $f0            ; $cf0c: 85 f0     
            rts                ; $cf0e: 60        
...
__d04f:     lda __d184,x       ; $d04f: bd 84 d1  
            ...
            lda $055b          ; $d057: ad 5b 05  
            sta $68            ; $d05a: 85 68     
            lda $055c          ; $d05c: ad 5c 05  
            sta $69            ; $d05f: 85 69     
...
__d0a8:     ldx #$0a           ; $d0a8: a2 0a     
            ...
            lda $055b          ; $d0b2: ad 5b 05  
            sta $47            ; $d0b5: 85 47     
            lda $055c          ; $d0b7: ad 5c 05  
            sta $48            ; $d0ba: 85 48     
            lda $40            ; $d0bc: a5 40     
            sta $3e            ; $d0be: 85 3e     
...
;-------------------------------------------------------------------------------
__d0e2:     ldx $0558          ; $d0e2: ae 58 05  
            lda __d10d,x       ; $d0e5: bd 0d d1  
            sta $0559          ; $d0e8: 8d 59 05  
            lda __d112,x       ; $d0eb: bd 12 d1  
            sta $055a          ; $d0ee: 8d 5a 05  
            lda __d117,x       ; $d0f1: bd 17 d1  
            sta $055b          ; $d0f4: 8d 5b 05  
            lda __d11c,x       ; $d0f7: bd 1c d1  
            sta $055c          ; $d0fa: 8d 5c 05  
            cpx #$04           ; $d0fd: e0 04     
            bcs __d104         ; $d0ff: b0 03     
            inc $0558          ; $d101: ee 58 05  
__d104:     lda #$00           ; $d104: a9 00     
            sta $05cd          ; $d106: 8d cd 05  
            sta $05ce          ; $d109: 8d ce 05  
            rts                ; $d10c: 60        

;-------------------------------------------------------------------------------
__d10d:     .hex 03 05 07 07   ; $d10d: 03 05 07 07   Data
            .hex 07            ; $d111: 07            Data
__d112:     .hex 80 90 98 a0   ; $d112: 80 90 98 a0   Data
            .hex a8            ; $d116: a8            Data
__d117:     .hex 01 01 02 02   ; $d117: 01 01 02 02   Data
            .hex 03            ; $d11b: 03            Data
__d11c:     .hex 00 05 00 05   ; $d11c: 00 05 00 05   Data
            .hex 00            ; $d120: 00            Data

;-------------------------------------------------------------------------------
__d121:     lda $05cd          ; $d121: ad cd 05  
            clc                ; $d124: 18        
            adc $05ce          ; $d125: 6d ce 05  
            cmp #$14           ; $d128: c9 14     
            rts                ; $d12a: 60        
...
__d1a2:     lda __d13e,x       ; $d1a2: bd 3e d1  
            ...
            ldx #$04           ; $d1aa: a2 04     
            ldy $05cd          ; $d1ac: ac cd 05  
            jsr __d1dc         ; $d1af: 20 dc d1  
            ldx #$12           ; $d1b2: a2 12     
            ldy $05ce          ; $d1b4: ac ce 05  
...
;-------------------------------------------------------------------------------
__d2a0:     ldy $3b            ; $d2a0: a4 3b     
            lda __db2a,y       ; $d2a2: b9 2a db  
            sta $1d            ; $d2a5: 85 1d     
            lda __db3a,y       ; $d2a7: b9 3a db  
            sta $1e            ; $d2aa: 85 1e     
...
;-------------------------------------------------------------------------------
__db27:     .hex 8c 9c ac      ; $db27: 8c 9c ac      Data
__db2a:     .hex 4a 59 f2 6c   ; $db2a: 4a 59 f2 6c   Data
            .hex 77 88 e1 6c   ; $db2e: 77 88 e1 6c   Data
            .hex 99 03 ca 6c   ; $db32: 99 03 ca 6c   Data
            .hex ad 17 e1 6c   ; $db36: ad 17 e1 6c   Data
__db3a:     .hex db db db db   ; $db3a: db db db db   Data
...
__e43c:     lda $0451,x        ; $e43c: bd 51 04  
            clc                ; $e43f: 18        
            adc #$02           ; $e440: 69 02     
            and #$03           ; $e442: 29 03     
...
;-------------------------------------------------------------------------------
__e8d1:     ldy $0451,x        ; $e8d1: bc 51 04  
            lda $31,x          ; $e8d4: b5 31     
            and #$02           ; $e8d6: 29 02     
...
__eb5a:     cmp #$e0           ; $eb5a: c9 e0     
            ...
            lda #$e0           ; $eb5e: a9 e0     
__eb60:     sta $91,x          ; $eb60: 95 91     
__eb62:     lda $c8            ; $eb62: a5 c8     
            ...
            lda #$c7           ; $eb70: a9 c7     
            sta $9a,x          ; $eb72: 95 9a     
            lda $0451,x        ; $eb74: bd 51 04  
            cmp #$0b           ; $eb77: c9 0b     
            bne __eb84         ; $eb79: d0 09     
            dec $0451,x        ; $eb7b: de 51 04  
...
;-------------------------------------------------------------------------------
__ed28:     ldy $88,x          ; $ed28: b4 88     
            dey                ; $ed2a: 88        
            bpl __ed2e         ; $ed2b: 10 01     
__ed2d:     rts                ; $ed2d: 60        

;-------------------------------------------------------------------------------
__ed2e:     lda $9a,x          ; $ed2e: b5 9a     
            cmp #$f9           ; $ed30: c9 f9     
...
__efea:     sty $12            ; $efea: 84 12     
            ldy $0451,x        ; $efec: bc 51 04  
            lda __f05e,y       ; $efef: b9 5e f0  
            sta $0451,x        ; $eff2: 9d 51 04  
            lda #$01           ; $eff5: a9 01     
            sta $047e,x        ; $eff7: 9d 7e 04  
            ldy $12            ; $effa: a4 12     
            cpy #$02           ; $effc: c0 02     
            bcs __f043         ; $effe: b0 43     
            lda $0451,x        ; $f000: bd 51 04  
            cmp #$07           ; $f003: c9 07     
            ...
            ora #$80           ; $f00d: 09 80     
            sta $f1            ; $f00f: 85 f1     
__f011:     ldy $0451,x        ; $f011: bc 51 04  
...
__f023:     lda __f082,y       ; $f023: b9 82 f0  
            ...
            pla                ; $f041: 68        
            tay                ; $f042: a8        
__f043:     lda $0451,x        ; $f043: bd 51 04  
            cmp #$0b           ; $f046: c9 0b     
...
__f1d9:     lda #$00           ; $f1d9: a9 00     
            ...
            sta $f0            ; $f1ee: 85 f0     
            lda #$02           ; $f1f0: a9 02     
__f1f2:     sta $41            ; $f1f2: 85 41     
            ldy $40            ; $f1f4: a4 40     
            bne __f1fa         ; $f1f6: d0 02     
            lda #$ff           ; $f1f8: a9 ff     
__f1fa:     sta $42            ; $f1fa: 85 42     
            ldx #$00           ; $f1fc: a2 00     
            stx $0488          ; $f1fe: 8e 88 04  
            stx $3b            ; $f201: 86 3b     
            stx $3c            ; $f203: 86 3c     
            stx $0558          ; $f205: 8e 58 05  
            dex                ; $f208: ca        
            stx $89            ; $f209: 86 89     
            ldx $40            ; $f20b: a6 40     
...
;-------------------------------------------------------------------------------
__f386:     lda $41,x          ; $f386: b5 41     
            bmi __f3ad         ; $f388: 30 23     
            lda __f3ae,x       ; $f38a: bd ae f3  
            sta $91,x          ; $f38d: 95 91     
            lda #$b8           ; $f38f: a9 b8     
            sta $9a,x          ; $f391: 95 9a     
            sta $bd,x          ; $f393: 95 bd     
...
;-------------------------------------------------------------------------------
__f3ae:     .hex 20 d0         ; $f3ae: 20 d0         Data

;-------------------------------------------------------------------------------
__f3b0:     lda #$03           ; $f3b0: a9 03     
            sta $0451,x        ; $f3b2: 9d 51 04  
            lda #$02           ; $f3b5: a9 02     
            sta $88,x          ; $f3b7: 95 88     
            rts                ; $f3b9: 60        
